...
\begin{table}[H]
    ...
    \begin{tabular}{cccc}
        \toprule
        $n_{eff,1} \rightarrow n_{eff,2}$ & $|\Re(C_{12})|$ & $|\chi_{11}| [m^{-1}]$ & $|\Re(\kappa_{12})| [m^{-1}]$ \\ 
        \midrule
        $1.1236 \rightarrow 1.1236$ & $0.0073$ & $1.0890 \cdot 10^5$ & $3366.5$ \\
        $1.1236 \rightarrow 1.1191$ & $2.2582 \cdot 10^{-7}$ & $1.0890 \cdot 10^5$ & $0.5$ \\
        $1.1236 \rightarrow 1.1056$ & $0.0154$ & $1.0890 \cdot 10^5$ & $7207.3$ \\
        \bottomrule
    \end{tabular}
    \caption{Butt coupling, inter-mode and auto-phase-shift coefficients for the coupled problem.}
